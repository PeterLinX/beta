...
const sweepKey = async (dispatch,wif,net,btc_balance,history) => {
    if (btc_balance <= 0 ) {
        ...
        if (validateForm(dispatch,send_address,net) === true) {
            ...
            sendPushTx(tx_raw);
            dispatch(sendEvent(true, "Sweep Successful! Your BTC balance will be automatically updated when the blockchain has processed one or more confirmations. Click the transaction link to view on the blockchain exlorer."));
        ...
        <div className="col-xs-12 center">
                    ...
                    <div id="sweepcont">
                        ...
                        <div className="col-xs-9">
                            <input className="form-send-white" id="wifprivatekey" placeholder={this.props.btcPrivKey}
