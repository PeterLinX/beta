      ...
      <div>
        ...
        <div id="send">
          ...
          <div className="send-notice">
            <p>
              All NEO and GAS transactions are FREE. Only send NEO or GAS to a
              valid NEO address. Sending NEO/GAS to an address other than a
              valid NEO address can result in your NEO/GAS being lost. You
              cannot send a fraction of a NEO. Please double check address and
