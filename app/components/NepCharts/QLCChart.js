...
const api = val => {
	return `https://min-api.cryptocompare.com/data/histohour?fsym=QLC&tsym=USD&limit=72&aggregate=3&e=CCCAGG`;
};
...
class Charts extends Component {
	...
	render() {
		...
		const data = canvas => {
			...
			gradientStroke.addColorStop(0, "#ae00d6");
			gradientStroke.addColorStop(1, "#ae00d6");

			let gradientFill = ctx.createLinearGradient(0, 0, 0, 360);
			gradientFill.addColorStop(0, "rgba(175,0,214, 0.5)");
			gradientFill.addColorStop(1, "rgba(175,0,214, 0)");
