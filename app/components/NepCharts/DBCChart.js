...
const api = val => {
	return `https://min-api.cryptocompare.com/data/histohour?fsym=DBC&tsym=USD&limit=72&aggregate=3&e=CCCAGG`;
};
...
class Charts extends Component {
	...
	render() {
		...
		const data = canvas => {
			...
			gradientStroke.addColorStop(0, "#5bc1d4");
			gradientStroke.addColorStop(1, "#5bc1d4");
