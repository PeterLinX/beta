...
const api = val => {
	return `https://min-api.cryptocompare.com/data/histohour?fsym=ONT&tsym=USD&limit=72&aggregate=3&e=CCCAGG`;
};
...
class Charts extends Component {
	...
	render() {
		...
		const data = canvas => {
			...
			gradientStroke.addColorStop(0, "#5ac1d4");
			gradientStroke.addColorStop(1, "#5ac1d4");

			let gradientFill = ctx.createLinearGradient(0, 0, 0, 360);
			gradientFill.addColorStop(0, "rgba(90,193,212, 0.5)");
			gradientFill.addColorStop(1, "rgba(90,193,212, 0)");
