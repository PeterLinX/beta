...
const api = val => {
	return `https://min-api.cryptocompare.com/data/histohour?fsym=BTC&tsym=USD&limit=72&aggregate=3&e=CCCAGG`;
};
...
class Charts extends Component {
	...
	render() {
		...
		const data = canvas => {
			...
			gradientStroke.addColorStop(0, "#ffc000");
			gradientStroke.addColorStop(1, "#ffc000");

			let gradientFill = ctx.createLinearGradient(0, 0, 0, 360);
			gradientFill.addColorStop(0, "rgba(229,172,0, 0.5)");
			gradientFill.addColorStop(1, "rgba(229,172,0, 0)");
