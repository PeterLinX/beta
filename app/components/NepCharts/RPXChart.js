...
const api = val => {
	return `https://min-api.cryptocompare.com/data/histohour?fsym=RPX&tsym=USD&limit=72&aggregate=3&e=CCCAGG`;
};
...
class Charts extends Component {
	...
	render() {
		...
		const data = canvas => {
			...
			gradientStroke.addColorStop(0, "#C60307");
			gradientStroke.addColorStop(1, "#C60307");

			let gradientFill = ctx.createLinearGradient(0, 0, 0, 360);
			gradientFill.addColorStop(0, "rgba(169,3,41, 0.5)");
			gradientFill.addColorStop(1, "rgba(169,3,41, 0)");
