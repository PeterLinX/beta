...
const api = val => {
	return `https://min-api.cryptocompare.com/data/histohour?fsym=TNC&tsym=USD&limit=72&aggregate=3&e=CCCAGG`;
};
...
class Charts extends Component {
	...
	render() {
		...
		const data = canvas => {
			...
			gradientStroke.addColorStop(0, "#fd489b");
			gradientStroke.addColorStop(1, "#fd489b");

			let gradientFill = ctx.createLinearGradient(0, 0, 0, 360);
			gradientFill.addColorStop(0, "rgba(217,64,134, 0.5)");
			gradientFill.addColorStop(1, "rgba(217,64,134, 0)");
