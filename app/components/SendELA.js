...
const sendTransaction = async (
    ...
    if (ela_balance <= 0) {
        ...
        console.log("elastos transaction generating");
        let data = selfAddress + send_address;
        let txid = sha256.hash(data);
        console.log("generating txid = " + txid);
                ...
                <div id="send">
                    <div className="row dash-panel-full">
                        <div className="col-xs-8">
                            ...
                            />
                            <h2>Send Elastos (ELA)</h2>
                        </div>

                        <div className="col-xs-4 center">
                            <div className="send-panel-price">
                                {numeral(this.props.ela).format("0,0.0000000")}{" "}
                                <span className="ltc-price"> ELA</span>
                            </div>

                            <span className="market-price">
                {numeral(this.props.ela * this.props.marketELAPrice).format(
                    "$0,0.00"
                )}{" "}
                                USD
              </span>
