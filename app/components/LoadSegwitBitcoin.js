...
class LoadSegwitBitcoin extends Component {
			...
			<div id="" className="">
				<div className="dash-panel">
						...
						<div className="col-xs-12">
							...
							/>
							<h2>Enter your Bitcoin (BTC) Segwit WIF/Private Key</h2>
							</div>
							...
							<div className="col-xs-9">
								...
								<input
									...
									placeholder="Enter a Bitcoin segwit private key to load funds"
									type="password"
									onChange={
										(val)=>{
                  ...
                  <p className="btc-notice" top-30>Please ensure that your Bitcoin private key is backed up. Entering your BTC private key here will allow you access to your funds. Your private key or BTC address will not be saved.</p>
...

							{
								this.state.pa !== '' ? (
									<div className="col-xs-9">
									<h4>Bitcoin (BTC) Segwit Public Address</h4>
							...
							<Link>
								<div className="btc-button" onClick={()=>this.login(dispatch)} ><span className="glyphicon glyphicon-eye-close marg-right-5"/> Load</div>
							</Link>
							</div>
						): null
						}
...
LoadSegwitBitcoin = connect(mapStateToProps)(LoadSegwitBitcoin);
export default LoadSegwitBitcoin;
