...
const validateForm = (dispatch, nrv_balance) => {
  ...
  if (
    parseInt(sendAmount.value) > nrv_balance) {
  ...
  render() {
    ...
    return (
      <div>
          ...
          <li className="active">Narrative</li>
          </ol>
          </div>
        ...
        <div id="send">
          <div className="row dash-chart-panel">
            ...
            ).format("0,0[.][0000]")} <span id="no-inverse" className="dbc-price"> NRVE</span></span><br />
          ...
          <div className="send-notice">
            <p>
              Sending Narrative (NRVE) NEP5 tokens require a balance of 0.00000001 GAS+. Only send NRVE to a valid address that supports NEP5+ tokens on the NEO blockchain. When sending NRVE to an exchange please ensure the address supports NRVE tokens.
            </p>
            </div>
          </div>
        </div>
