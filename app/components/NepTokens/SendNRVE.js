      ...
      <div>
        ...
        <div id="send">
          ...
          <div className="send-notice">
            <p>
              Sending NRVE requires a balance of 0.00000001 GAS+. Only send NRVE to a valid address that supports NEP5+ tokens on the NEO blockchain. When sending NRVE to an exchange please ensure the address supports NRVE tokens.
            </p>
